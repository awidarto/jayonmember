...
function __get_thumbnail($delivery_id, $class = 'thumb'){
	$CI =& get_instance();
...
function old_send_notification($subject,$to,$cc = null,$template = 'default',$data = null,$attachment = null){
	$CI =& get_instance();
