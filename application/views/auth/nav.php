		...
		?>
			...
			<?php if(user_group('merchant')):?><li class="<?php print set_hilite('admin\/delivery')?>" ><?php if(user_group('merchant')) { echo anchor('admin/delivery/incoming', 'Orders'); } ?><?php endif;?>
				<ul>
					...
					<?php if(user_group('buyer') || user_group('merchant')):?><li class="<?php print set_hilite('admin\/delivery\/log')?>" ><?php if(user_group('buyer') || user_group('merchant')) { echo anchor('admin/delivery/log', 'Delivery Log'); } ?></li><?php endif;?>
				</ul>
			</li>
