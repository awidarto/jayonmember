                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="fine">ID : </span><span class="fine" id="merchant_id_txt"><?php print $merchant_id?></span><br />
                                    ...
                                    <input type="hidden" id="merchant_name" name="merchant_name" value="<?php print $merchantname?>" />
                                    <input type="hidden" value="<?php print $merchant_id?>" id="merchant_id" name="merchant_id" />
                                    <input type="hidden" value="<?php print $merchantfullname?>" id="merchant_fullname" name="merchant_fullname" />
                                    <input type="hidden" value="<?php print $merchantemail?>" id="merchant_email" name="merchant_email" />
                                </td>
                            </tr>
                            <tr>
                                <td>Store Name<hr /><span class="fine">Nama Toko</span></td>
                                <td id="application_id">
                                    <?php print $appselect;?><br />
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for"delivery_bearer">Delivery Fee :</label><br />
                                        <?php print form_checkbox(array('name'=>'delivery_bearer','id'=>'delivery_bearer','value'=>'buyer','checked'=>($merchantdata['mc_delivery_bearer'] == 'buyer')?TRUE:FALSE ));?> Bill buyer / tagihkan ke buyer
                                    <br />
                                    <label for="cod_surcharge_bearer">COD / CCOD Surcharges:</label><br />
                                        <?php print form_checkbox(array('name'=>'cod_surcharge_bearer','id'=>'cod_surcharge_bearer','value'=>'buyer','checked'=>($merchantdata['mc_cod_bearer'] == 'buyer')?TRUE:FALSE ));?> Bill buyer / tagihkan ke buyer
                                </td>
                            </tr>
                            <tr>
