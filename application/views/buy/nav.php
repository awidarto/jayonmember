...
<?php
	...
	?>
		...
		<li class="<?php print set_hilite('admin\/location\/tracker')?>" ><?php if(user_group('merchant') OR user_group('buyer')) { echo anchor('admin/location/tracker', 'Location Tracker'); } ?></li>
