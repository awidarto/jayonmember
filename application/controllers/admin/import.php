...
class Import extends Application
{
    ...
    public function index()
    {
        ...
        $page['merchant_name'] = $this->session->userdata('merchantname');
        $page['merchant_email'] = $this->session->userdata('mc_email');
        $page['merchant_fullname'] = $this->session->userdata('fullname');
